<template>
  <div class="space-y-6">
    <PageHeader
      :eyebrow="isEdit ? 'Admin · Edit tag' : 'Admin · New tag'"
      ...
      <div class="card-body">
        ...
        <form v-else class="space-y-4" @submit.prevent="onSubmit" novalidate>
          ...
          <div class="flex gap-3">
            ...
            <router-link class="btn btn-outline" to="/tags">Cancel</router-link>
          </div>
        </form>
      </div>
    </div>
...
import { tagSchema } from 'core/utils/validators'
import type { CreateTagPayload } from 'core/interfaces/tag'
...
onMounted(async () => {
  ...
  try {
    ...
    notificationStore.showToast('Failed to load tag.', 'error')
  } finally {
