...
export const useEcommerceStore = defineStore('ecommerce', () => {
  ...
  function addToCart(product: Product) {
    ...
    if (existing) {
      existing.quantity += 1
      notificationStore.showToast(`Updated quantity for ${product.title}.`, 'info')
      return
    }
    ...
    notificationStore.showToast(`Added ${product.title} to cart.`, 'success')
  }
  ...
  function addToCartFromItem(item: {
    ...
    notificationStore.showToast(`Added ${item.title} to cart.`, 'success')
  }
  ...
  function toggleWishlist(product: Product) {
    ...
    if (existing) {
      ...
      notificationStore.showToast(`Removed ${product.title} from wishlist.`, 'warning')
      return
    }
    ...
    notificationStore.showToast(`Saved ${product.title} to wishlist.`, 'success')
  }
  ...
  function placeOrder() {
    ...
    cart.value = []
    notificationStore.showToast(`Order ${newOrder.id} placed successfully!`, 'success')
    return newOrder
  }
