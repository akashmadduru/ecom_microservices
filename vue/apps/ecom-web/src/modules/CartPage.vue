  ...
  <div class="min-h-screen px-4 py-10 text-base-content">
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <div v-if="ecommerceStore.cart.length" class="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <div class="space-y-4">
          <div v-for="item in ecommerceStore.cart" :key="item.id" class="card card-side">
            <figure class="w-32 p-3">
              <AppImage
                :src="item.image_urls"
                alt=""
                img-class="h-24 w-24 rounded-[1rem] object-cover"
              />
            </figure>
        ...
        <div class="card">
          <div class="card-body space-y-4">
            ...
            <div class="flex justify-between text-lg font-semibold text-base-content">
      ...
      <EmptyState
        ...
        description="Pick a few favorites and come back here to check out."
...
import EmptyState from 'lib/components/EmptyState.vue'
